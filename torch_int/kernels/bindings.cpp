...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("linear_relu_a8_w8_b8_o8", &linear_relu_a8_w8_b8_o8,
        "Linear ReLU (INT8)");
  m.def("linear_gelu_a8_w8_b8_o8", &linear_gelu_a8_w8_b8_o8,
        "Linear GELU (INT8)");
  m.def("linear_a8_w8_b32_o32", &linear_a8_w8_b32_o32, "Linear (INT32)");
  m.def("linear_a8_w8_bfp32_ofp32", &linear_a8_w8_bfp32_ofp32,
        "Linear (I8-OFP32)");
  m.def("linear_gelu_a8_w8_bfp32_ofp32", &linear_gelu_a8_w8_bfp32_ofp32,
        "Linear GELU (I8-OFP32)");
  ...
  m.def("bmm_f32t_f32n_f32t", &bmm_f32t_f32n_f32t, "BMM (FP32 I FP32 O) A x B.T");
